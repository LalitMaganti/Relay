...
public class ModeParser implements CommandParser {
    ...
    private void parseChannelMode(final List<String> parsedArray, final String channelName,
        ...
        Optionals.run(optChannel,
                channel -> onUserModeInChannel(parsedArray, sendingUser, channel, mode),
    ...
    private void onUserModeInChannel(final List<String> parsedArray, final String sendingNick,
        ...
        if (optUser.isPresent()) {
            ...
            event = appUser
                    ? new ChannelUserLevelChangeEvent(channel, mode, mUserChannelGroup.getUser(),
