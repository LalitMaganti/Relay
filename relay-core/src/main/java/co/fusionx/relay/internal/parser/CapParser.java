...
import static co.fusionx.relay.constant.CapCapability.SASL;
import static co.fusionx.relay.constant.CapCapability.getCapabilityFromString;
...
public class CapParser {
    ...
    @Inject
    public CapParser(final co.fusionx.relay.core.ConnectionConfiguration configuration, final InternalServer server,
